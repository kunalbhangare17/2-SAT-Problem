...
n = 2  # n=2 Boolean variables: x1, x2
num_variables_per_clause = 2  # 2: hence the name 2-sat

# _: denotes not
variables_dict = {'x1': True, '_x1': False, 'x2': True, '_x2': False}

# A, a set of satisfiable assignment of truth variables: x1 = True, x2 = False
A = {'x1': True, 'x2': False}
...
k = len(set_of_clauses)  # k=4 clauses

print('CNF clauses: ')
print(set_of_clauses)
print('')

variable_assignment = {'x1': False, 'x2': False}
